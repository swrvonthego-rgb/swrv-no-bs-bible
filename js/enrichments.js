...
(function(){
  ...
  // Merge Exodus 13-15 deep build
  if(window.EXODUS_PLOT_PANELS && window.EXODUS1315_PLOT_PANELS){
    for(const k in window.EXODUS1315_PLOT_PANELS) window.EXODUS_PLOT_PANELS[k] = window.EXODUS1315_PLOT_PANELS[k];
  }
  if(window.EXODUS_HEARTBEAT_CALLOUTS && window.EXODUS1315_HEARTBEAT){
    for(const k in window.EXODUS1315_HEARTBEAT) window.EXODUS_HEARTBEAT_CALLOUTS[k] = window.EXODUS1315_HEARTBEAT[k];
  }
  if(window.EXODUS_CULTURE_BOXES && window.EXODUS1315_CULTURE){
    for(const k in window.EXODUS1315_CULTURE) window.EXODUS_CULTURE_BOXES[k] = window.EXODUS1315_CULTURE[k];
  }
  if(window.EXODUS_AMP_STYLE && window.EXODUS1315_AMP_STYLE){
    for(const k in window.EXODUS1315_AMP_STYLE) window.EXODUS_AMP_STYLE[k] = window.EXODUS1315_AMP_STYLE[k];
  }
  if(window.DEFINITIONS && window.EXODUS1315_DEFINITIONS){
    for(const k in window.EXODUS1315_DEFINITIONS){
      window.DEFINITIONS[k] = window.EXODUS1315_DEFINITIONS[k];
      window.DEFINITIONS[k.toLowerCase()] = window.EXODUS1315_DEFINITIONS[k];
    }
    console.log('Exodus 13-15 deep build: '+Object.keys(window.EXODUS1315_DEFINITIONS).length+' new deep definitions added');
  }
  // Merge Exodus 16-18 deep build
  if(window.EXODUS_PLOT_PANELS && window.EXODUS1618_PLOT_PANELS){
    for(const k in window.EXODUS1618_PLOT_PANELS) window.EXODUS_PLOT_PANELS[k] = window.EXODUS1618_PLOT_PANELS[k];
  }
  if(window.EXODUS_HEARTBEAT_CALLOUTS && window.EXODUS1618_HEARTBEAT){
    for(const k in window.EXODUS1618_HEARTBEAT) window.EXODUS_HEARTBEAT_CALLOUTS[k] = window.EXODUS1618_HEARTBEAT[k];
  }
  if(window.EXODUS_CULTURE_BOXES && window.EXODUS1618_CULTURE){
    for(const k in window.EXODUS1618_CULTURE) window.EXODUS_CULTURE_BOXES[k] = window.EXODUS1618_CULTURE[k];
  }
  if(window.EXODUS_AMP_STYLE && window.EXODUS1618_AMP_STYLE){
    for(const k in window.EXODUS1618_AMP_STYLE) window.EXODUS_AMP_STYLE[k] = window.EXODUS1618_AMP_STYLE[k];
  }
  if(window.DEFINITIONS && window.EXODUS1618_DEFINITIONS){
    for(const k in window.EXODUS1618_DEFINITIONS){
      window.DEFINITIONS[k] = window.EXODUS1618_DEFINITIONS[k];
      window.DEFINITIONS[k.toLowerCase()] = window.EXODUS1618_DEFINITIONS[k];
    }
    console.log('Exodus 16-18 deep build: '+Object.keys(window.EXODUS1618_DEFINITIONS).length+' new deep definitions added');
  }
  // Merge Exodus 19-24 deep build
  if(window.EXODUS_PLOT_PANELS && window.EXODUS1924_PLOT_PANELS){
    for(const k in window.EXODUS1924_PLOT_PANELS) window.EXODUS_PLOT_PANELS[k] = window.EXODUS1924_PLOT_PANELS[k];
  }
  if(window.EXODUS_HEARTBEAT_CALLOUTS && window.EXODUS1924_HEARTBEAT){
    for(const k in window.EXODUS1924_HEARTBEAT) window.EXODUS_HEARTBEAT_CALLOUTS[k] = window.EXODUS1924_HEARTBEAT[k];
  }
  if(window.EXODUS_CULTURE_BOXES && window.EXODUS1924_CULTURE){
    for(const k in window.EXODUS1924_CULTURE) window.EXODUS_CULTURE_BOXES[k] = window.EXODUS1924_CULTURE[k];
  }
  if(window.EXODUS_AMP_STYLE && window.EXODUS1924_AMP_STYLE){
    for(const k in window.EXODUS1924_AMP_STYLE) window.EXODUS_AMP_STYLE[k] = window.EXODUS1924_AMP_STYLE[k];
  }
  if(window.DEFINITIONS && window.EXODUS1924_DEFINITIONS){
    for(const k in window.EXODUS1924_DEFINITIONS){
      window.DEFINITIONS[k] = window.EXODUS1924_DEFINITIONS[k];
      window.DEFINITIONS[k.toLowerCase()] = window.EXODUS1924_DEFINITIONS[k];
    }
    console.log('Exodus 19-24 deep build: '+Object.keys(window.EXODUS1924_DEFINITIONS).length+' new deep definitions added');
  }
  // Merge Exodus 25-40 deep build
  if(window.EXODUS_PLOT_PANELS && window.EXODUS2540_PLOT_PANELS){
    for(const k in window.EXODUS2540_PLOT_PANELS) window.EXODUS_PLOT_PANELS[k] = window.EXODUS2540_PLOT_PANELS[k];
  }
  if(window.EXODUS_HEARTBEAT_CALLOUTS && window.EXODUS2540_HEARTBEAT){
    for(const k in window.EXODUS2540_HEARTBEAT) window.EXODUS_HEARTBEAT_CALLOUTS[k] = window.EXODUS2540_HEARTBEAT[k];
  }
  if(window.EXODUS_CULTURE_BOXES && window.EXODUS2540_CULTURE){
    for(const k in window.EXODUS2540_CULTURE) window.EXODUS_CULTURE_BOXES[k] = window.EXODUS2540_CULTURE[k];
  }
  if(window.EXODUS_AMP_STYLE && window.EXODUS2540_AMP_STYLE){
    for(const k in window.EXODUS2540_AMP_STYLE) window.EXODUS_AMP_STYLE[k] = window.EXODUS2540_AMP_STYLE[k];
  }
  if(window.DEFINITIONS && window.EXODUS2540_DEFINITIONS){
    for(const k in window.EXODUS2540_DEFINITIONS){
      window.DEFINITIONS[k] = window.EXODUS2540_DEFINITIONS[k];
      window.DEFINITIONS[k.toLowerCase()] = window.EXODUS2540_DEFINITIONS[k];
    }
    console.log('Exodus 25-40 deep build: '+Object.keys(window.EXODUS2540_DEFINITIONS).length+' new deep definitions added');
  }
})();
