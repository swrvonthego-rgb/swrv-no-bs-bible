...
const CORE_ASSETS = [
  ...
  './manifest.json',
  './css/styles.css',
  './js/app.js?v=20260517culturepass1',
  './js/search.js?v=20260517culturepass1',
  './js/preload-bible.js?v=20260517culturepass1',
  './data/english-bible-dictionary.js?v=20260517culturepass1',
  './data/context-sense-disambiguator.js?v=20260517culturepass1',
  './data/cultural-context-cards.js?v=20260517culturepass1',
  './data/instruction-classification.js?v=20260517culturepass1',
  './data/person-context-cards.js?v=20260517culturepass1',
  './data/group-nation-cards.js?v=20260517culturepass1',
  './data/religion-context-cards.js?v=20260517culturepass1',
  './assets/cover.png',
